...
background:linear-gradient(rgba(12,13,14,.78),rgba(12,13,14,.9) 38%,rgba(12,13,14,.96) 70%,var(--void))}
...
.top{border-bottom:1px solid var(--rule);background:radial-gradient(130% 200% at 6% 0%,rgba(36,19,24,.72) 0%,rgba(12,13,14,.6) 60%)}
