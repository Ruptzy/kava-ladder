...
.pban{display:none;position:relative;margin:0 0 1rem;border:1px solid var(--rule-2);border-radius:6px;overflow:hidden;background:#0A0B0C;max-width:440px}
.pban.has{display:block}
.pban img{display:block;width:100%;max-height:360px;object-fit:contain}
.pban::after{content:"";position:absolute;inset:auto 0 0 0;height:34%;background:linear-gradient(transparent,rgba(10,11,12,.85));pointer-events:none}
.pban b{position:absolute;left:.9rem;bottom:.7rem;z-index:2;font-family:var(--fm);font-size:.58rem;letter-spacing:.16em;text-transform:uppercase;color:var(--ink-2);font-weight:400}
...
<div class="phead2"><div class="pban" id="pban"></div><div class="pnick" id="pnick"></div><div class="ph2row"><div id="pav"></div><div style="min-width:0"><h1 id="pname"></h1><div class="psub" id="psub"></div></div></div><div class="pact" id="pact"></div></div>
...
function showProfile(n,rival){
  ...
  var ban=$("#pban"); ban.className="pban";
  ban.innerHTML='<img src="photos/scene/'+slug(p.n)+'.jpg" alt="'+E(p.n)+' at the board" onload="this.parentNode.classList.add(&quot;has&quot;)"><b>At the club</b>';
