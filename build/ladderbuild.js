...
@media(max-width:640px){
  ...
  .ptro{margin:.6rem 0 0;padding:.6rem 0 0;border-left:none;border-top:1px solid var(--rule-2);flex:1 1 100%}
  .ptro .tset{justify-content:space-around;gap:.3rem}
  .tprev{text-align:center}
  .ptro .it{min-width:0}
  .ptro .pic{width:60px;height:60px}
  .ptro .n{font-size:1.25rem}
