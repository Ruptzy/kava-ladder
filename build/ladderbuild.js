...
background:linear-gradient(rgba(12,13,14,.5),rgba(12,13,14,.66) 32%,rgba(12,13,14,.78) 62%,rgba(12,13,14,.86))}
...
.top{border-bottom:1px solid var(--rule);background:radial-gradient(130% 200% at 6% 0%,rgba(36,19,24,.62) 0%,rgba(12,13,14,.45) 60%)}
