...
background:linear-gradient(rgba(12,13,14,.34),rgba(12,13,14,.52) 32%,rgba(12,13,14,.66) 62%,rgba(12,13,14,.78))}
...
.top{border-bottom:1px solid var(--rule);background:radial-gradient(130% 200% at 6% 0%,rgba(36,19,24,.5) 0%,rgba(12,13,14,.3) 60%)}
