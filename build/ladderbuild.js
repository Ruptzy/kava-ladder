...
@media(max-width:640px){
  ...
  .wm small{font-size:.7rem;letter-spacing:.16em;margin-top:.4rem;gap:.45rem}
  .wm small::after{max-width:70px}
...
<div class="box"><div class="sc"><table><thead><tr>
<th style="padding-left:1rem">Player</th><th class="r">Games</th><th>Seasons 1&ndash;7</th><th>Seasons 8 &amp; 9</th><th>All time</th>
...
function drawAllTime(){
  ...
  $("#alltime").innerHTML=rows.map(r=>'<tr data-n="'+E(r.n)+'" tabindex="0" role="button">'+
    ...
    '<td class="wdl">'+r.old.rec.join("\u2013")+'<i style="margin-left:.4rem">as '+E(r.old.n)+'</i></td>'+
    '<td class="wdl">'+r.now.join("\u2013")+'</td>'+
